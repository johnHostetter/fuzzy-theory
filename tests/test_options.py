...
from fuzzy.utils.options.impl.impl_enums import (BoundAlphaEntmaxEnum,
                                                 NeurogenesisEnum,
...
from fuzzy.utils.options.impl.impl_options import (
    _64_BIT_INT, BoundAlphaEntmax, EvolutionConfig, GumbelConfig,
    NeuroFuzzyNetworkHyperparameters, PremiseActivation, PremiseAggregation,
    PremiseConfig, Range, RuleConfig)
